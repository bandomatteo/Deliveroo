 ...
 * It uses a Map to store parcels, where the key is the parcel's ID and the value is an instance of Parcel.
 * @property {Map} map - A Map to store parcels, where the key is the parcel's ID and the value is a Parcel instance.
 * @property {Me} me - The local player object
 * @property {Array} parcelsArray - Array of parcel objects to update the store with
 * @property {MapStore} mapStore - The MapStore instance containing the game map
 * @property {ServerConfig} config - The server configuration object
 */
